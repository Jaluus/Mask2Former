...
class MultiScaleMaskedTransformerDecoder_CLIP_DOMAINTEXTPERTURB(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        self.cityscapes_classes = [
            ...
            ["sky", "Atmosphere", "Heavens", "Firmament"],
            [
                "person",
                "Pedestrian",
                "Walker",
    ...
    def generate_query_embed_weights(self):
        ...
        for i in range(len(self.cityscapes_classes)):
            ...
            class_string = f"{self.start_words[random_startword_idx[i]]} {self.image_descriptions[random_image_description_idx[i]]} {self.image_types[random_image_type_idx[i]]} {self.class_descriptions[random_class_description_idx[i]]} {self.cityscapes_classes[i][random_class_idx]} {self.connector_words[random_connector_idx[i]]} {self.weather_conditions[random_weather_idx[i]]} {self.times_of_day[random_time_idx[i]]} {self.suffixes[random_suffix_idx[i]]}"
            class_texts.append(class_string.lower())

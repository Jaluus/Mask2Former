...
class ACDCEvaluator(DatasetEvaluator):
    """
    ...
    def reset(self):
        self._working_dir = tempfile.TemporaryDirectory(prefix="ACDC_eval_")
        ...
        self._logger.info(
            "Writing ACDC results to temporary directory {} ...".format(self._temp_dir)
        )


class ACDCSemSegEvaluator(ACDCEvaluator):
    """

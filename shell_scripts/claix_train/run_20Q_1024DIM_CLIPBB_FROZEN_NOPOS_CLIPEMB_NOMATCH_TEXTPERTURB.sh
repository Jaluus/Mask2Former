...
#SBATCH --mem=200GB
#SBATCH --gres=gpu:8
#SBATCH --job-name="M2F 20Q 1024DIM CLIPBB FROZEN NOPOS CLIPEMB NOMATCH TEXTPERTURB"
...
# Set the model name
model_name=maskformer2_20Q_1024DIM_CLIPBB_FROZEN_NOPOS_CLIPEMB_NOMATCH_TEXTPERTURB
